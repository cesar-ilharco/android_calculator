...
public class Factorial implements Function1<Integer, BigDecimal> {
    ...
    public static BigDecimal rawFactorial(int n){
    ...
    public static BigDecimal thunkFactorial(int n){
        return parallelFactorial(n, 1);
    }

    public static BigDecimal parallelFactorial(int n){
    ...
    public static List<Integer> getPartition (int n, int p){
